...
fun UpdateScreen(navHostController: NavHostController) {
    ...
    val sampleStatus = listOf(
        StatusData(image = R.drawable.mrbeast, name = "Mr Beast", time = "Just now"),
        StatusData(image = R.drawable.carryminati, name = "Carry", time = "10 minutes ago"),
        StatusData(image = R.drawable.rashmika, name = "Rashmika", time = "40 minutes ago"),
        StatusData(image = R.drawable.salman_khan, name = "Salman Khan", time = "20 hours ago"),
    )

    val sampleChannels = listOf(
        Channel(
            image = R.drawable.sga,
            name = "Super Gamer Ashish",
            description = "Latest Gaming Update"
        ),

        Channel(
            image = R.drawable.img,
            name = "Food Lover",
            description = "Testy Foods"
        ),

        Channel(
            image = R.drawable.whatsapp_icon,
            name = "WhatsApp",
            description = "Connect with ur love one"
        ),
    ...
    Scaffold(floatingActionButton = {
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                Text(text = "Stay Update on topics that matters to you. Find channels to follow below.")
